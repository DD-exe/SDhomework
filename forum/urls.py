...
from .views import home, post_list, new_post, delete_post, edit_post, post_detail, collect_post, remove_collect, new_comment, delete_comment, new_reply, delete_reply
